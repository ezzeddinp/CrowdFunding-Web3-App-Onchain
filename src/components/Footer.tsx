...
const Footer = () => {
  return (
    <footer className="mt-auto bg-gradient-to-b from-black to-blue-950/30 border-t border-blue-500/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-blue-300/60">
              The next generation of crowdfunding powered by blockchain
              technology. Secure, transparent, and decentralized.
            </p>
          </div>

          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-blue-400">Quick Links</h3>
          ...
          <div className="mt-8 pt-8 border-t border-blue-500/20">
            <p className="text-center text-xs text-blue-300/60">
              © 2025 CrowdFund. All rights reserved. Powered by Blockchain
              Technology.
            </p>
          </div>
        </div>
