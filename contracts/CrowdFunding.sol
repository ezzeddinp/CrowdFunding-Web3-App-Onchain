...
contract CrowdFunding {
    ...
    modifier onlyOwner {
        require(msg.sender == owner, "The contract is not owned by the");
        _;
    }

    modifier campaignOpen() {
        require(state == CampaignState.Active, "The campaign is not open");
        _;
    }
    ...
    constructor(
        ...
        goal = _goal;
        deadline = block.timestamp + (_durationInDays * 1 days); // Converting to seconds
        owner = msg.sender;
    ...
    function addTier(
        ...
        require(_amount > 0, "Amount cannot under 0");
    ...
    function withdraw() public onlyOwner {
        ...
        // jika diatas 0 maka transfer ke owner
